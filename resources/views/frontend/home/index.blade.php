        ...
        <div class="container ">
            <div class="row row-new-film shadow-lg">
                @for($i = 0 ; $i < 3 ; $i++)
                    ...
                    <div class="col-10   col-md-4" data-toggle="tooltip" data-placement="top" title="{{ $newPosts[$i]->header_title }}">

                        <a href="{{ route('frontend.movies.single' , $newPosts[$i]->slug) }}">
                            <div class="card text-white shadow mt-3 mb-5">
                                <img class="card-img" src="{{ $newPosts[$i]->image }}" alt="{{ $newPosts[$i]->image_alt }}">
