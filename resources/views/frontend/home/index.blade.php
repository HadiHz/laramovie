...
@endsection
@section('newFilm')
    @if(isset($newPosts) && count($newPosts) == 7)
        ...
        @foreach($allResults as $result)
            ...
            @if($result instanceof \App\Models\Movie)
                ...
                <div class="section-film-preview bg-light w-100">
                    ...
                    <div class="row mt-4 mb-3">
                        <div class="col-12 col-md-6 text-right mt-3 ">
                            ...
                            <p class="pr-3"><span><img src="/img/appointment.png" alt=""></span>
                                <span class="field-film">تاریخ اکران  : </span> <span>{{ $movie->release_year }}</span>
                            </p>
                        </div>
                    ...
                    <?php
                    $temp = \Morilog\Jalali\CalendarUtils::strftime('Y/m/d', strtotime($movie->updated_at));
                    ...
                    <div class="row mr-0 text-center download-link-section w-100">
                        <div class="col-12 col-md-6 time-section text-light pr-0 pt-3 pb-3 pl-0 ">
                            <span>تاریخ انتشار : </span><span>{{ $date }}</span>
                        </div>
            ...
            @else
                @if($result instanceof \App\Models\Serial)
                    ...
                    <div class="section-film-preview bg-light w-100">
                        ...
                        <div class="row mt-4 mb-3">
                            <div class="col-12 col-md-6 text-right mt-3 ">
                                ...
                                <p class="pr-3"><span><img src="/img/appointment.png" alt=""></span>
                                    ...
                                    <span>{{ $serial->release_date->format('d-m-Y') }}</span>
                                </p>
                        ...
                        <?php
                        $temp = \Morilog\Jalali\CalendarUtils::strftime('Y/m/d', strtotime($serial->updated_at));
                        $date = \Morilog\Jalali\CalendarUtils::convertNumbers($temp);
                        ?>
                        <div class="row mr-0 text-center download-link-section w-100">
                            <div class="col-12 col-md-6 time-section text-light pr-0 pt-3 pb-3 pl-0 ">
