    ...
    <div class="pr-0 pb-3 pl-0 bg-light w-100 shadow text-right">
        ...
        <form method="post" action="{{ route('frontend.comment.store',['id' => $movieItem->id,'flag'=>1]) }}">
            ...
            <div class="form-group pr-2 pl-2">
                ...
                <input type="text" class="form-control" name="sender_name" id="comment_sender_name" placeholder="لطفا نام خود را در این قسمت وارد کنید">
            </div>
            <div class="form-group pr-2 pt-4 pb-4 pl-2">
                <label for="exampleInputEmail1">ایمیل شما</label>
                <input type="email" class="form-control" name="sender_email" id="comment_sender_email" aria-describedby="emailHelp" placeholder="لطفا ایمیل خود را اینجا وارد کنید">
            ...
            <div class="form-group pr-2 pl-2">
                ...
                <textarea class="form-control" placeholder="دیدگاه خود را در این قسمت بنویسید ...." name="body" id="comment_body" rows="6"></textarea>
